...
import styles from './AllAppRoundFour.module.css';
...
function AllAppRoundFour({ setActiveTab }) {
  ...
  const jobData = {
    title: 'Senior UI/UX Designer - Round Four',
  ...
  const handleSubmitInterviewResult = (resultData) => {
    ...
    console.log('Interview result saved (Round 4):', newResult);
  };
  ...
  return (
    <div className={styles.AllAppRoundFour__wrapper}>
      <JobDetailsHeader
        title={jobData.title}
        ...
        actions={[
          {
            label: 'Select',
            className: styles.AllAppRoundFour__selectBtn,
...
export default AllAppRoundFour;
