...
import styles from './AllAppRoundThree.module.css';
...
function AllAppRoundThree({ setActiveTab }) {
  ...
  const handleSubmitInterviewResult = (resultData) => {
    ...
    console.log('Interview result saved (Round 3):', newResult);
  };
  ...
  return (
    <div className={styles.AllAppRoundThree__wrapper}>
      <JobDetailsHeader
        title={jobData.title}
        ...
        actions={[
          {
            label: 'Select',
            className: styles.AllAppRoundThree__selectBtn,
...
export default AllAppRoundThree;
