...
import styles from './SelectedCandidRoundThree.module.css';
...
function SelectedCandidRoundThree({ setActiveStep }) {
  ...
  const handleScheduleInterviewSubmit = (formValues) => {
    console.log('Third round scheduled with values:', formValues);
    setShowScheduleModal(false);
    setActiveStep && setActiveStep(4); 
  };

  return (
    <div className={styles.SelectedCandidRoundThree__wrapper}>
      <JobDetailsHeader
        title={jobData.title}
        skills={jobData.skills}
        actions={[
          {
            label: 'Schedule Fourth Round',
...
export default SelectedCandidRoundThree;
