...
import styles from './AllAppRoundOne.module.css';
...
function AllAppRoundOne({ setActiveTab }) {
    ...
    const handleSubmitInterviewResult = (resultData) => {
        // Store the result along with the candidate info
        const newResult = {
        ...
        console.log('Interview result saved:', newResult);
    };
    ...
    return (
        <div className={styles.AllAppRoundOne__wrapper}>
            <JobDetailsHeader
                title={jobData.title}
                ...
                actions={[
                    {
                        label: 'Select',
                        className: styles.AllAppRoundOne__selectBtn,
